...
import { getAllUsers, deleteUser, bulkDeleteUsers, updateUserRole, getAllRooms, deleteRoom, bulkDeleteRooms, getStats, importEvents, getSupportRequests, updateSupportRequest, replyToSupportRequest, getCatalog, updateCatalogCard } from '../controllers/adminController.js';
...
router.put('/catalog/:category/:sourceName', updateCatalogCard);
