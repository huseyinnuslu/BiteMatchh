...
const Settings = () => {
  ...
  const requestEmailChange = async (event) => {
    ...
    if (email === profile.email) { setEmailChangeStep('idle'); return; }
    setSavingEmail(true);
    try {
