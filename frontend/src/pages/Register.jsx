  ...
  return (
    <div className="flex-center animate-slide-up" style={{ minHeight: '80vh', padding: '2rem 0' }}>
      ...
      <div className="glass-card" style={{ width: '100%', maxWidth: '440px' }}>
        ...
        {/* E-posta kaydından sonra ikincil alternatif olarak konumlanır. */}
        {GOOGLE_ENABLED && <div style={{ marginTop: '1.35rem' }}>
          <div style={{ position: 'relative', textAlign: 'center', margin: '0 0 1.1rem' }}>
            <hr style={{ border: 'none', borderTop: '1px solid rgba(255,255,255,0.1)' }} />
            <span style={{ position: 'absolute', top: '-10px', left: '50%', transform: 'translateX(-50%)', background: 'var(--surface)', padding: '0 10px', color: 'var(--text-muted)', fontSize: '0.82rem' }}>veya</span>
          </div>
          <button
            type="button"
            onClick={handleGoogleLogin}
            disabled={googleLoading}
            style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.65rem', padding: '0.8rem 1rem', background: '#ffffff', color: '#3c4043', border: '1px solid #dadce0', borderRadius: '8px', fontSize: '0.95rem', fontWeight: 600, cursor: googleLoading ? 'not-allowed' : 'pointer', opacity: googleLoading ? 0.7 : 1, transition: 'all 0.2s ease' }}
